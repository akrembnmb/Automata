                    ...
                    def Page_Intial():
                        ...
                        def Final_States_Page():
                            ...
                            def Automat_Welcome_Page():
                                ...
                                def Verify_Word():
                                    if (Aut_Type):
                                        dfa = DFA(states=set(States),input_symbols=set(Letters_List),transitions=Transitions_Dict,initial_state=Initial_state[0],final_states=set(final_states))
                                        if  dfa.accepts_input(Word_String.get()):
                                            print('accepted')
                                        else:
                                                print('rejected')
